...
Esto tuvo hartos cambios, pero basicamente el proceso solo aumenta su waiting time cuando esta en estado `WAITING` o `READY` sin ser elegido para la proximo periodo tick.
